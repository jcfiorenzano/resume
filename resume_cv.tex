...
\name{Juan Carlos}{Fiorenzano Gonzalez}
\address{10702 27th DR SE, Everett, WA, 98208}
\mobile{(305)-833-5169 }

\email{jcfiorenzano23@gmail.com}
\linkedin{jcfiorenzano}
%\skype{skypeid}
...
\makecvfooter{\today}{Juan C. Fiorenzano~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
